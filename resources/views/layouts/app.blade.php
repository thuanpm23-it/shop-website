...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="front/images/icons/favicon.png"/>
<!--===============================================================================================-->
	...
	<div class="container-menu-desktop">
		...
		<div class="top-bar">
			<div class="content-topbar flex-sb-m h-full container">
				...
				<div class="right-top-bar flex-w h-full">
                    ...
                    <a class="flex-c-m trans-04 p-lr-25" href="{{route('register')}}">Register</a>
                    @else
					<a class="flex-c-m trans-04 p-lr-25" href="{{route('myaccount.orders')}}">My Orders</a>
                    <form id="logout" action="{{route('logout')}}" method="POST">
                        <a role="button" class="flex-c-m trans-04 p-lr-25" onclick="document.getElementById('logout').submit();" style="cursor: pointer">Logout</a>
                        @csrf
                    </form>
                    @endguest
		...
		<div class="wrap-menu-desktop how-shadow1">
			<nav class="limiter-menu-desktop container">
				...
				<!-- Logo desktop -->		
				<a href="#" class="logo">
					<img src="front/images/icons/logo-01.png" alt="IMG-LOGO">
				</a>
				...
				<div class="wrap-icon-header flex-w flex-r-m">
					...
					<a href="{{route('cart.index')}}"   class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti  js-show-cart"
			...
			<ul class="header-cart-wrapitem w-full">
				<li class="header-cart-item flex-w flex-t m-b-12">
					<div class="header-cart-item-img">
						<img src="front/images/item-cart-01.jpg" alt="IMG">
					</div>
				...
				<li class="header-cart-item flex-w flex-t m-b-12">
					<div class="header-cart-item-img">
						<img src="front/images/item-cart-02.jpg" alt="IMG">
					</div>
				...
				<li class="header-cart-item flex-w flex-t m-b-12">
					<div class="header-cart-item-img">
						<img src="front/images/item-cart-03.jpg" alt="IMG">
					</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!--===============================================================================================-->
        <script src="front/vendor/perfect-scrollbar/perfect-scrollbar.min.js"></script>
        <script>
